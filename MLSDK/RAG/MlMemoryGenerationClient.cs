...
public class MlMemoryGenerationClient : MlTextGenerationClientBase
{
    ...
    private const string MemoryTypeDescription = "Specifies how long this memory should be kept and how it is intended to be used.";
    ...
    public MlMemoryGenerationClient(string url, GenerationConfig config, IGrammarBuilder grammarBuilder) : base(url, config)
    {
    ...
    private void InitializeGrammar()
    {
        ...
        var memoryImportance = new GrammarValue(MemoryImportanceKey, GrammarRequirement.Required, memoryImportanceEnum);
    ...
    public async Task<GenerationResult<MemoryBlock>> SendMemoryBlockGenerationRequest(string generationMessage, string userMessage, string aiMessage = null)
    {
